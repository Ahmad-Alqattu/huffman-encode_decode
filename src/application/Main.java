...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			btcompress.setStyle(
					"-fx-background-color: #c8d8e4; -fx-text-fill: black;-fx-font-size: 20px;-fx-font-weight: bold;");
			btextract.setStyle(
					"-fx-background-color: #c8d8e4; -fx-text-fill: black;-fx-font-size: 20px;-fx-font-weight: bold;");
			...
			top.setStyle("-fx-background-color: #2b6777 ;-fx-background-radius: 0px 0px 20% 20% ;");
			...
			btHeader.setStyle("-fx-background-color: #3284C2; -fx-text-fill: white;-fx-font-size: 16px;");

			Button btHaffman = new Button("Haffman Code");
			btHaffman.setPadding(new Insets(10, 26, 10, 26));
			btHaffman.setStyle("-fx-background-color: #3284C2; -fx-text-fill: white;-fx-font-size: 16px;");

			Button btFrequancy = new Button("Frequancy");
			btFrequancy.setPadding(new Insets(10, 40, 10, 40));
			btFrequancy.setStyle("-fx-background-color: #3284C2; -fx-text-fill: white;-fx-font-size: 16px;");
			...
			masseg.setStyle(" -fx-text-fill: #0090B1 ;-fx-font-size: 30px;-fx-font-weight: bold;");
			...
			btcompress.setOnAction(e -> {
				...
				try {
					...
					masseg.setText("compression Done ");
				...
				try {
					...
					if (File.endsWith(".huf")) {
						...
						try {
							...
							fsource.setText(File);
							masseg.setText("Decompression Done ");
